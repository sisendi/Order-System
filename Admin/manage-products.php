...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <a tittle="Edit Details"
                                                    href="edit-products.php?id=<?php echo $row['id']?>"><i
                                                        class="icon-edit"></i></a>
                                                <a tittle="Add Quantity"
                                                    href="addqty-products.php?id=<?php echo $row['id']?>"><i
                                                        class="icon-plus"></i></a>
                                                <a tittle="Remove Products"
                                                    href="manage-products.php?id=<?php echo $row['id']?>&del=delete"
