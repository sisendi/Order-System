...
<head>
    ...
    <title>Admin| Rejected Orders</title>
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['email']);?>/<?php echo htmlentities($row['contactno']);?>
                                            </td>
                                            ...
                                            <td> <a href="javascript:void(0);"
                                                    onClick="popUpWindow('updateorder.php?oid=<?php echo htmlentities($row['OrderID']);?>');"
