                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="productCompany"
                                                ...
                                                class="span8 tip" required readonly="true">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="productDescription" placeholder="Enter Product Description"
                                                rows="6" class="span8 tip" readonly="true">
<?php echo htmlentities($row['productDescription']);?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select readonly="true" name="productAvailability" id="productAvailability"
                                                class="span8 tip" required>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage2']);?>"
                                                width="200" height="100"> <a
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage3']);?>"
                                                width="200" height="100"> <a
